    ...
    QWidget(parent)
{
    ...
    QLabel* versionLabel = new QLabel(tr("Version") + " 0.1.5");
    ...
    QLabel* licenseLabel = new QLabel(tr("Distributed under the terms of the<br />GNU General Public Licence version 2"));
