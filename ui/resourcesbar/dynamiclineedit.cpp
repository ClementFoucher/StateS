...
DynamicLineEdit::DynamicLineEdit(const QString& content, bool beginAsRefused, QWidget* parent) :
...
{
    disconnect(this, SIGNAL(editingFinished()), this, SLOT(userValidated()));
...
void DynamicLineEdit::focusInEvent(QFocusEvent* event)
{
    ...
    connect(this, SIGNAL(editingFinished()), this, SLOT(userValidated()));
