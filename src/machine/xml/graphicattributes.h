...
public:
	...
	// Object functions
public:
	void addAttribute(ComponentId componentId, QString name, QString value);
	QString getAttribute(ComponentId componentId, QString name);

	/////
	// Object variables
private:
	QMap<ComponentId, QMap<QString, QString>> attributes;
